...
Route::middleware([
    ...
    ->group(function () {
        ...
        Route::get('/dashboard/youth-participation', [DashboardController::class, 'youthParticipation'])
            ->name('dashboard.youth-participation');

        // Sub-Admin User Management (Root Admin Only)
        Route::middleware('role:admin')->prefix('users')->name('users.')->group(function () {
            Route::get('/', [AdminUserController::class, 'index'])->name('index');
            Route::post('/', [AdminUserController::class, 'store'])->name('store');
            Route::post('/{user}', [AdminUserController::class, 'update'])->name('update');
            Route::post('/{user}/email', [AdminUserController::class, 'changeEmail'])->name('change-email');
            Route::post('/{user}/status', [AdminUserController::class, 'toggleStatus'])->name('toggle-status');
            Route::post('/{user}/delete', [AdminUserController::class, 'destroy'])->name('destroy');
        });

        Route::middleware('module:youth_records')->prefix('barangay-library')->name('barangay-library.')->group(function () {
        ...
        Route::middleware('module:sk_officials')->prefix('sk-officials')->name('sk-officials.')->group(function () {
            ...
            Route::post('/{skOfficial}/email', [SkOfficialController::class, 'changeEmail'])->name('change-email');
            Route::post('/{skOfficial}/delete', [SkOfficialController::class, 'destroy'])->name('destroy');
        });

        Route::middleware('module:sk_officials')->prefix('lydc-members')->name('lydc-members.')->group(function () {
        ...
        Route::middleware('module:youth_records')->prefix('resident-youth')->name('resident-youth.')->group(function () {
            ...
            Route::post('/{youthProfile}/email', [ResidentYouthController::class, 'changeEmail'])->name('change-email');
            Route::post('/{youthProfile}/organization', [ResidentYouthController::class, 'assignOrganization'])->name('organization');
        ...
        // ECESPRO Module Group
        Route::middleware('module:ecespro')->group(function () {
            // ECESPRO Programs
            ...
            Route::post('ecespro-exam-batches/{ecespro_exam_batch}/mark-complete', [EcesproExamBatchController::class, 'markAsComplete']);
            ...
            Route::post('ecespro-interview-batches/{ecespro_interview_batch}/mark-complete', [EcesproInterviewBatchController::class, 'markAsComplete']);
            ...
            Route::post('ecespro-contract-signing-batches/{ecespro_contract_batch}/mark-complete', [EcesproContractBatchController::class, 'markAsComplete']);
            ...
            // Exam Questionnaires
            Route::get('ecespro-exam-questionnaires', [EcesproExamQuestionnaireController::class, 'index']);
            Route::post('ecespro-exam-questionnaires', [EcesproExamQuestionnaireController::class, 'store']);
            Route::get('ecespro-exam-questionnaires/{questionnaire}', [EcesproExamQuestionnaireController::class, 'show']);
            Route::post('ecespro-exam-questionnaires/{questionnaire}/update', [EcesproExamQuestionnaireController::class, 'update']);
            Route::post('ecespro-exam-questionnaires/{questionnaire}/delete', [EcesproExamQuestionnaireController::class, 'destroy']);
            ...
            Route::post('ecespro-exam-questionnaires/{questionnaire}/questions/{question}/delete', [EcesproExamQuestionnaireController::class, 'destroyQuestion']);
            ...
            Route::post('ecespro-examination-setups/{setup}/delete', [EcesproExaminationSetupController::class, 'destroy']);
        ...
        // ECESPRO Settings
        Route::middleware('module:settings_ecespro')->group(function () {
        ...
        // Landing Page Hero
        Route::middleware('module:settings_hero')->group(function () {
        ...
        Route::middleware('module:settings_auth_hero')->group(function () {
        ...
        // Contact & Socials
        Route::middleware('module:settings_contact')->group(function () {
        ...
        Route::middleware('module:settings_email')->group(function () {
