...
<head>
    ...
    <title>Facility Booking Confirmed</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 38px 32px 30px 32px;">
                            ...
                            <p style="color: #475569; margin: 0 0 24px 0; font-size: 15px; line-height: 1.6; text-align: center;">
                                Hello <strong>{{ $user->name }}</strong>, your reservation for <strong>{{ $facility->name ?? 'the requested facility' }}</strong> has been directly booked and confirmed.
                            </p>
