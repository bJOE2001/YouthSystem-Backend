...
<head>
    ...
    <title>TCYDO Announcement</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 38px 32px 30px 32px;">
                            ...
                            <p style="color: #475569; margin: 0 0 24px 0; font-size: 15px; line-height: 1.6; text-align: center;">
                                Hello <strong>{{ $user->name }}</strong>, a new official announcement has been published by TCYDO.
                            </p>
                            ...
                            <div style="text-align: center; margin: 0 0 28px 0;">
                                <a href="{{ $announcementUrl }}" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #07823f 0%, #0b6b3a 100%); color: #ffffff; text-decoration: none; padding: 14px 34px; font-size: 15px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 12px rgba(7, 130, 63, 0.3);">
                                    View on Portal &rarr;
                                </a>
                            </div>
