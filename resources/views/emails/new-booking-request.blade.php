...
<head>
    ...
    <title>New Facility Booking Request</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 38px 32px 30px 32px;">
                            ...
                            <p style="color: #475569; margin: 0 0 24px 0; font-size: 15px; line-height: 1.6; text-align: center;">
                                A new facility reservation request has been submitted and is awaiting your review and approval.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 22px 24px; text-align: left;">
                                        ...
                                        <div style="margin-bottom: 12px;">
                                            <span style="color: #64748b; font-size: 12px; font-weight: 500; display: block; margin-bottom: 2px;">Requester Name</span>
                                            <span style="color: #0f172a; font-size: 15px; font-weight: 700;">{{ $requester->name ?? 'Participant' }} ({{ $requester->email ?? 'N/A' }})</span>
                                        </div>
                                        ...
                                        <div style="margin-bottom: 12px;">
                                            <span style="color: #64748b; font-size: 12px; font-weight: 500; display: block; margin-bottom: 2px;">Requested Date</span>
                            ...
                            <div style="text-align: center; margin: 0 0 28px 0;">
                                <a href="{{ $portalUrl }}" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #07823f 0%, #0b6b3a 100%); color: #ffffff; text-decoration: none; padding: 14px 34px; font-size: 15px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 12px rgba(7, 130, 63, 0.3);">
                                    Review Request in Admin Portal &rarr;
                                </a>
                            </div>
