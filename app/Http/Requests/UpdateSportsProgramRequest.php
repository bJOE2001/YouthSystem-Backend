...
class UpdateSportsProgramRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => 'sometimes|required|string|in:Program,Project,Activity',
            'strategicDirection' => 'sometimes|required|string',
